...
public class Exercises {
        ...
        private static void exercise1() {
            ...
            System.out.println("Rectangle area is: " + rectangle.calculateArea() + " cm^2");
            System.out.println("Circle area is: " + circle.calculateArea() + " cm^2");
        }
        ...
        private static void exercise2() {
            ...
            // Your code here
            Car car = new Car();
            Boat bananaBoat = new Boat();

            System.out.println(bananaBoat.moveForward());
            System.out.println(bananaBoat.moveBackward());
        ...
        private static void exercise3() {
            System.out.println("\nExercise 3: ");
            // Your code here
            Guitar guitar = new Guitar("Ibanez", "JGM10");
            Piano piano = new Piano("Steinway", "XX90");
