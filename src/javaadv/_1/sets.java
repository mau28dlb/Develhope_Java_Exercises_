...
public class sets {
        ...
        private static void exercise2() {
            ...
            //2a. What will this output? [avrò come output il set ma con un ordine diverso da quello in cui sono stati inseriti gli items]
            ...
            //2b. What will this output? [avrò il set del 2a ma con in aggiunta gli items di "fruitsList" che non erano già presente in fruitsSet]
            System.out.println(fruitsSet);
        }
        ...
        private static void exercise4() {
            ...
            int min = Integer.MAX_VALUE;
            // Your code
            for (Integer value : orderedNumbers) {
                if (value < min ) {
                     min = value;
            }
