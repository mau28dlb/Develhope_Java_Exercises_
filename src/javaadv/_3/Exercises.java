...
import java.util.*;
    ...
    public class Exercises {
        ...
        public static Set<String> toSet (Collection<String> strings) {
         ...
         *    Answer: Map (i have a key student and a value grade)
         *
         ...
         *    Answer: Map (got product as key and price as value)
         *
