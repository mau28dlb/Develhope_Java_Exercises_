...
public class More_string_stringbuilder {
    ...
    private static void exercise1() {
        ...
        int ourInt = Integer.valueOf(ourNumberStr);
        ourInt += 2;
        ourNumberStr = String.valueOf(ourInt);
    ...
    private static void exercise2() {
        ...
        int charAtIndex = 6; // <--- Ho inserito il valore 6 perché la w è il sesto carattere della stringa anotherString
    ...
    private static void exercise3() {
        ...
        String doubleStrToConvert = "25.5"; // Also this line
    ...
    private static void exercise4() {
        System.out.println("\nExercise 4:");
        String startStr = "5";
        int convertedString = Integer.valueOf(startStr);
        convertedString *= 2;
        startStr = String.valueOf(convertedString);
        startStr = startStr + startStr;
        double finalValue = Double.valueOf(startStr);
        finalValue /= 3.5;

        System.out.println(Math.floor(finalValue));
    }
}